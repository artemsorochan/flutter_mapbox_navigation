...
public class FlutterMapboxNavigationView : NavigationFactory, FlutterPlatformView
{
    ...
    init(messenger: FlutterBinaryMessenger, frame: CGRect, viewId: Int64, args: Any?)
    {
        ...
        self.channel = FlutterMethodChannel(name: "flutter_mapbox_navigation", binaryMessenger: messenger)
        self.eventChannel = FlutterEventChannel(name: "flutter_mapbox_navigation/events", binaryMessenger: messenger)
